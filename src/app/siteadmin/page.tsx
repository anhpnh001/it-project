...
import Create from '@/app/create/page'; // Your course creation component
import Users from '@/app/users/page'; // Your user management component
    ...
    <div className="flex h-screen bg-gray-100">
      <aside className="w-64 bg-white p-5 border-r">
        ...
        <ul className="mt-5">
          ...
          <AdminLink href="#" label="Grades" Icon={<FaChartBar />} onClick={handleSectionClick('grades')} />
          <AdminLink href="#" label="Plugins" Icon={<FaPlug />} onClick={handleSectionClick('plugins')} />
          <AdminLink href="#" label="Appearance" Icon={<FaPalette />} onClick={handleSectionClick('appearance')} />
          <AdminLink href="#" label="Server" Icon={<FaServer />} onClick={handleSectionClick('server')} />
          <AdminLink href="#" label="Reports" Icon={<FaFileAlt />} onClick={handleSectionClick('reports')} />
        </ul>
      </aside>
