      ...
      <header className="container">
        ...
        <div className="flex items-center justify-between p-8">
          <div className="flex flex-col justify-center items-start w-1/2 gap-4 py-16">
            <p className="text-left">
              ...
              capabilities across various age groups. From young learners to
              adult education, our curricula are designed to build strong
              cognitive foundations and elevate educational experiences.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center p-8">
          <p className="text-center">
            Here at [Your Organization], we are committed to fostering talent and dedication,
            enabling individuals like Phan Ngoc Hoàng Anh and Nguyễn Minh Mẫn to achieve their
            full potential. Our programs are designed to provide the necessary tools and
